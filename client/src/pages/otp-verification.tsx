      ...
      <div className="px-8 py-12 h-full flex flex-col">
          ...
          <div className="flex justify-center space-x-3 mb-8">
            {otp.map((digit, index) => (
              <motion.input
                ...
                className={`w-12 h-12 text-center text-xl font-bold bg-white/10 border-2 rounded-xl text-white focus:outline-none transition-all
        ...
        <div className="mt-auto">
          <motion.button
            ...
            className={`w-full py-4 px-6 rounded-full font-semibold shadow-lg transition-all
        ...
        <div className="mt-6 grid grid-cols-3 gap-4 max-w-xs mx-auto">
          {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((num) => (
            <motion.button
              key={num}
              whileTap={{ scale: 0.95 }}
              className="aspect-square bg-white/10 rounded-xl text-white text-xl font-semibold hover:bg-white/20 transition-colors"
              onClick={() => {
          ...
          <motion.button
            whileTap={{ scale: 0.95 }}
            className="aspect-square bg-white/10 rounded-xl text-white text-xl font-semibold hover:bg-white/20 transition-colors flex items-center justify-center"
            onClick={() => {
