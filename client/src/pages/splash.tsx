...
export default function SplashScreen() {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="gradient-bg min-h-screen min-h-[100dvh] flex items-center justify-center mobile-content"
    >
      <div className="text-center">
        ...
        <motion.div
          ...
          className="h-1 bg-white/30 rounded-full mx-auto mt-6 sm:mt-8"
        />
        ...
        <motion.h1
          ...
          className="text-responsive-xl font-bold text-white mt-4"
        >
          tempo
        </motion.h1>
      </div>
